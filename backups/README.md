...
## v0.6 批次快照（2026-09-20）
| 文件（前缀 = 改动前状态） | 节点 |
|---|---|
| geometry.js.gmfix.bak | GM ITS(F7)+NRPT 累积修复前 |
| geometry.js.cardfix.bak | GX packed I2 + GW GC 锥度修复前 |
| js_i18n_zh.js.gmfix/cardfix.bak · js_i18n_en.js.gmfix/cardfix.bak | 语言包词条增补前 |
| m3_geometry.js.gmfix/cardfix.bak | 几何回归断言扩充前 |
| *.v06.bak（maa-writer / index.html / zh / en / r19 / sf2 / r21 / AGENTS / README / README.en / backups_README） | v0.6 版本标记前 |
